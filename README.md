...
**Prerequisites:** Python 3.10, Ollama running locally with `mxbai-embed-large` and
`llama3.2:1b` pulled. The generated data (`data/`, `results/`) exists locally; it is gitignored
and can be rebuilt with the commands below.
...
- `results/*.json` — outputs of the evaluation runs.
